const services = [
	...
	},
	{
		...
		description: 'The firm provides advisory and compliance support in matters relating to Foreign Exchange Management Act (FEMA) and allied regulations, including:',
		points: ['Review of foreign remittances and reporting requirements', 'Advisory on cross-border transactions', 'Coordination with authorised dealer banks', 'Regulatory filings and documentation support'],
		icon: (
			<svg
				aria-hidden="true"
				className="h-6 w-6"
	...
	},
	{
		...
		description: "The firm undertakes advisory assignments aimed at supporting clients' financial and compliance objectives, including:",
		points: ['Accounting and financial advisory', ' MIS and reporting framework design', 'Business and financial analysis', 'Process review and optimisation', 'Startup and MSME advisory'],
		icon: (
			<svg
				aria-hidden="true"
				className="h-6 w-6"
	...
	{
		title: 'Legal & Representation Support',
		description: 'With the support of Advocates associated with the firm, H S D G & Associates provides legal and representation support in coordination with its tax and compliance teams, including:',
		points: ['Drafting of replies and representations', 'Litigation coordination and support', 'Legal documentation review', 'Advisory on procedural and regulatory matters'],
		icon: (
			<svg
				aria-hidden="true"
				className="h-6 w-6"
	...
	{
		title: 'Foreign Desk – Inbound Investment & Outsourced Services',
		description: 'The Foreign Desk supports foreign clients by providing:',
		points: ['Outsourced accounting, finance, and compliance support from India', 'Assistance to foreign entities for incorporation of companies and LLPs in India', 'Advisory on entry structures, regulatory requirements, and compliance frameworks in India', 'Support in FEMA and RBI related compliances for inbound investments', 'Ongoing tax, GST, corporate, and secretarial compliance support for Indian entities with foreign ownership', 'Coordination with authorised dealer banks, legal advisors, and other intermediaries, where required'],
		icon: (
			<svg
				aria-hidden="true"
				className="h-6 w-6"
	...
	return (
		<section className="bg-white py-12">
			...
			<div className="mx-auto w-full max-w-7xl px-6">
				...
				{/* FIXED GRID — THIS MAKES 7XL VISUALLY WORK */}
				<div className="mt-10 grid gap-6 grid-cols-[repeat(auto-fit,minmax(260px,1fr))]">

					{services.map((service) => (
						<article
							key={service.title}
							className="rounded-2xl border border-divider bg-white p-5 shadow-sm transition-shadow hover:shadow-md"
						>
